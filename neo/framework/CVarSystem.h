...
public:
	...
	void					SetString( const char *_value ) { internalVar->InternalSetString(_value); }
	void					SetBool( const bool _value) { internalVar->InternalSetBool(_value); }
	void					SetInteger( const int _value) { internalVar->InternalSetInteger(_value); }
	void					SetFloat( const float _value) { internalVar->InternalSetFloat(_value); }
...
ID_INLINE void idCVar::Init( const char *_name, const char *_value, int _flags, const char *_description,
							float _valueMin, float _valueMax, const char **_valueStrings, argCompletion_t _valueCompletion ) {
	this->name = _name;
	this->value = _value;
	this->flags = _flags;
	this->description = _description;
	this->flags = _flags | CVAR_STATIC;
	this->valueMin = _valueMin;
	this->valueMax = _valueMax;
	this->valueStrings = _valueStrings;
	this->valueCompletion = _valueCompletion;
	this->integerValue = 0;
