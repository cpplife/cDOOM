...
bool idMat4::InverseFastSelf() {
	...
	idMat2 r0, r1, r2, r3;
	float a, det, invDet;
	float *_mat = reinterpret_cast<float *>(this);

	// r0 = m0.Inverse();
	det = _mat[0*4+0] * _mat[1*4+1] - _mat[0*4+1] * _mat[1*4+0];
	...
	r0[0][0] =   _mat[1*4+1] * invDet;
	r0[0][1] = - _mat[0*4+1] * invDet;
	r0[1][0] = - _mat[1*4+0] * invDet;
	r0[1][1] =   _mat[0*4+0] * invDet;

	// r1 = r0 * m1;
	r1[0][0] = r0[0][0] * _mat[0*4+2] + r0[0][1] * _mat[1*4+2];
	r1[0][1] = r0[0][0] * _mat[0*4+3] + r0[0][1] * _mat[1*4+3];
	r1[1][0] = r0[1][0] * _mat[0*4+2] + r0[1][1] * _mat[1*4+2];
	r1[1][1] = r0[1][0] * _mat[0*4+3] + r0[1][1] * _mat[1*4+3];

	// r2 = m2 * r1;
	r2[0][0] = _mat[2*4+0] * r1[0][0] + _mat[2*4+1] * r1[1][0];
	r2[0][1] = _mat[2*4+0] * r1[0][1] + _mat[2*4+1] * r1[1][1];
	r2[1][0] = _mat[3*4+0] * r1[0][0] + _mat[3*4+1] * r1[1][0];
	r2[1][1] = _mat[3*4+0] * r1[0][1] + _mat[3*4+1] * r1[1][1];

	// r3 = r2 - m3;
	r3[0][0] = r2[0][0] - _mat[2*4+2];
	r3[0][1] = r2[0][1] - _mat[2*4+3];
	r3[1][0] = r2[1][0] - _mat[3*4+2];
	r3[1][1] = r2[1][1] - _mat[3*4+3];
	...
	// r2 = m2 * r0;
	r2[0][0] = _mat[2*4+0] * r0[0][0] + _mat[2*4+1] * r0[1][0];
	r2[0][1] = _mat[2*4+0] * r0[0][1] + _mat[2*4+1] * r0[1][1];
	r2[1][0] = _mat[3*4+0] * r0[0][0] + _mat[3*4+1] * r0[1][0];
	r2[1][1] = _mat[3*4+0] * r0[0][1] + _mat[3*4+1] * r0[1][1];

	// m2 = r3 * r2;
	_mat[2*4+0] = r3[0][0] * r2[0][0] + r3[0][1] * r2[1][0];
	_mat[2*4+1] = r3[0][0] * r2[0][1] + r3[0][1] * r2[1][1];
	_mat[3*4+0] = r3[1][0] * r2[0][0] + r3[1][1] * r2[1][0];
	_mat[3*4+1] = r3[1][0] * r2[0][1] + r3[1][1] * r2[1][1];

	// m0 = r0 - r1 * m2;
	_mat[0*4+0] = r0[0][0] - r1[0][0] * _mat[2*4+0] - r1[0][1] * _mat[3*4+0];
	_mat[0*4+1] = r0[0][1] - r1[0][0] * _mat[2*4+1] - r1[0][1] * _mat[3*4+1];
	_mat[1*4+0] = r0[1][0] - r1[1][0] * _mat[2*4+0] - r1[1][1] * _mat[3*4+0];
	_mat[1*4+1] = r0[1][1] - r1[1][0] * _mat[2*4+1] - r1[1][1] * _mat[3*4+1];

	// m1 = r1 * r3;
	_mat[0*4+2] = r1[0][0] * r3[0][0] + r1[0][1] * r3[1][0];
	_mat[0*4+3] = r1[0][0] * r3[0][1] + r1[0][1] * r3[1][1];
	_mat[1*4+2] = r1[1][0] * r3[0][0] + r1[1][1] * r3[1][0];
	_mat[1*4+3] = r1[1][0] * r3[0][1] + r1[1][1] * r3[1][1];
...
bool idMat5::InverseFastSelf() {
	...
	float *mat_ = reinterpret_cast<float *>(this);
	...
	r0[0][0] = c0 * invDet;
	r0[0][1] = ( mat_[0*5+2] * mat_[2*5+1] - mat_[0*5+1] * mat_[2*5+2] ) * invDet;
	r0[0][2] = ( mat_[0*5+1] * mat_[1*5+2] - mat_[0*5+2] * mat_[1*5+1] ) * invDet;
	r0[1][0] = c1 * invDet;
	r0[1][1] = ( mat_[0*5+0] * mat_[2*5+2] - mat_[0*5+2] * mat_[2*5+0] ) * invDet;
	r0[1][2] = ( mat_[0*5+2] * mat_[1*5+0] - mat_[0*5+0] * mat_[1*5+2] ) * invDet;
	r0[2][0] = c2 * invDet;
	r0[2][1] = ( mat_[0*5+1] * mat_[2*5+0] - mat_[0*5+0] * mat_[2*5+1] ) * invDet;
	r0[2][2] = ( mat_[0*5+0] * mat_[1*5+1] - mat_[0*5+1] * mat_[1*5+0] ) * invDet;

	// r1 = r0 * m1;		// 3x2 = 3x3 * 3x2
	r1[0][0] = r0[0][0] * mat_[0*5+3] + r0[0][1] * mat_[1*5+3] + r0[0][2] * mat_[2*5+3];
	r1[0][1] = r0[0][0] * mat_[0*5+4] + r0[0][1] * mat_[1*5+4] + r0[0][2] * mat_[2*5+4];
	r1[1][0] = r0[1][0] * mat_[0*5+3] + r0[1][1] * mat_[1*5+3] + r0[1][2] * mat_[2*5+3];
	r1[1][1] = r0[1][0] * mat_[0*5+4] + r0[1][1] * mat_[1*5+4] + r0[1][2] * mat_[2*5+4];
	r1[2][0] = r0[2][0] * mat_[0*5+3] + r0[2][1] * mat_[1*5+3] + r0[2][2] * mat_[2*5+3];
	r1[2][1] = r0[2][0] * mat_[0*5+4] + r0[2][1] * mat_[1*5+4] + r0[2][2] * mat_[2*5+4];

	// r2 = m2 * r1;		// 2x2 = 2x3 * 3x2
	r2[0][0] = mat_[3*5+0] * r1[0][0] + mat_[3*5+1] * r1[1][0] + mat_[3*5+2] * r1[2][0];
	r2[0][1] = mat_[3*5+0] * r1[0][1] + mat_[3*5+1] * r1[1][1] + mat_[3*5+2] * r1[2][1];
	r2[1][0] = mat_[4*5+0] * r1[0][0] + mat_[4*5+1] * r1[1][0] + mat_[4*5+2] * r1[2][0];
	r2[1][1] = mat_[4*5+0] * r1[0][1] + mat_[4*5+1] * r1[1][1] + mat_[4*5+2] * r1[2][1];

	// r3 = r2 - m3;		// 2x2 = 2x2 - 2x2
	r3[0][0] = r2[0][0] - mat_[3*5+3];
	r3[0][1] = r2[0][1] - mat_[3*5+4];
	r3[1][0] = r2[1][0] - mat_[4*5+3];
	r3[1][1] = r2[1][1] - mat_[4*5+4];
	...
	r2[0][0] = mat_[3*5+0] * r0[0][0] + mat_[3*5+1] * r0[1][0] + mat_[3*5+2] * r0[2][0];
	r2[0][1] = mat_[3*5+0] * r0[0][1] + mat_[3*5+1] * r0[1][1] + mat_[3*5+2] * r0[2][1];
	r2[0][2] = mat_[3*5+0] * r0[0][2] + mat_[3*5+1] * r0[1][2] + mat_[3*5+2] * r0[2][2];
	r2[1][0] = mat_[4*5+0] * r0[0][0] + mat_[4*5+1] * r0[1][0] + mat_[4*5+2] * r0[2][0];
	r2[1][1] = mat_[4*5+0] * r0[0][1] + mat_[4*5+1] * r0[1][1] + mat_[4*5+2] * r0[2][1];
	r2[1][2] = mat_[4*5+0] * r0[0][2] + mat_[4*5+1] * r0[1][2] + mat_[4*5+2] * r0[2][2];

	// m2 = r3 * r2;		// 2x3 = 2x2 * 2x3
	mat_[3*5+0] = r3[0][0] * r2[0][0] + r3[0][1] * r2[1][0];
	mat_[3*5+1] = r3[0][0] * r2[0][1] + r3[0][1] * r2[1][1];
	mat_[3*5+2] = r3[0][0] * r2[0][2] + r3[0][1] * r2[1][2];
	mat_[4*5+0] = r3[1][0] * r2[0][0] + r3[1][1] * r2[1][0];
	mat_[4*5+1] = r3[1][0] * r2[0][1] + r3[1][1] * r2[1][1];
	mat_[4*5+2] = r3[1][0] * r2[0][2] + r3[1][1] * r2[1][2];

	// m0 = r0 - r1 * m2;	// 3x3 = 3x3 - 3x2 * 2x3
	mat_[0*5+0] = r0[0][0] - r1[0][0] * mat_[3*5+0] - r1[0][1] * mat_[4*5+0];
	mat_[0*5+1] = r0[0][1] - r1[0][0] * mat_[3*5+1] - r1[0][1] * mat_[4*5+1];
	mat_[0*5+2] = r0[0][2] - r1[0][0] * mat_[3*5+2] - r1[0][1] * mat_[4*5+2];
	mat_[1*5+0] = r0[1][0] - r1[1][0] * mat_[3*5+0] - r1[1][1] * mat_[4*5+0];
	mat_[1*5+1] = r0[1][1] - r1[1][0] * mat_[3*5+1] - r1[1][1] * mat_[4*5+1];
	mat_[1*5+2] = r0[1][2] - r1[1][0] * mat_[3*5+2] - r1[1][1] * mat_[4*5+2];
	mat_[2*5+0] = r0[2][0] - r1[2][0] * mat_[3*5+0] - r1[2][1] * mat_[4*5+0];
	mat_[2*5+1] = r0[2][1] - r1[2][0] * mat_[3*5+1] - r1[2][1] * mat_[4*5+1];
	mat_[2*5+2] = r0[2][2] - r1[2][0] * mat_[3*5+2] - r1[2][1] * mat_[4*5+2];

	// m1 = r1 * r3;		// 3x2 = 3x2 * 2x2
	mat_[0*5+3] = r1[0][0] * r3[0][0] + r1[0][1] * r3[1][0];
	mat_[0*5+4] = r1[0][0] * r3[0][1] + r1[0][1] * r3[1][1];
	mat_[1*5+3] = r1[1][0] * r3[0][0] + r1[1][1] * r3[1][0];
	mat_[1*5+4] = r1[1][0] * r3[0][1] + r1[1][1] * r3[1][1];
	mat_[2*5+3] = r1[2][0] * r3[0][0] + r1[2][1] * r3[1][0];
	mat_[2*5+4] = r1[2][0] * r3[0][1] + r1[2][1] * r3[1][1];
...
bool idMat6::InverseFastSelf() {
	...
	// r0 = m0.Inverse();
	c0 = mat_[1*6+1] * mat_[2*6+2] - mat_[1*6+2] * mat_[2*6+1];
	c1 = mat_[1*6+2] * mat_[2*6+0] - mat_[1*6+0] * mat_[2*6+2];
	c2 = mat_[1*6+0] * mat_[2*6+1] - mat_[1*6+1] * mat_[2*6+0];

	det = mat_[0*6+0] * c0 + mat_[0*6+1] * c1 + mat_[0*6+2] * c2;
	...
	r0[0][0] = c0 * invDet;
	r0[0][1] = ( mat_[0*6+2] * mat_[2*6+1] - mat_[0*6+1] * mat_[2*6+2] ) * invDet;
	r0[0][2] = ( mat_[0*6+1] * mat_[1*6+2] - mat_[0*6+2] * mat_[1*6+1] ) * invDet;
	r0[1][0] = c1 * invDet;
	r0[1][1] = ( mat_[0*6+0] * mat_[2*6+2] - mat_[0*6+2] * mat_[2*6+0] ) * invDet;
	r0[1][2] = ( mat_[0*6+2] * mat_[1*6+0] - mat_[0*6+0] * mat_[1*6+2] ) * invDet;
	r0[2][0] = c2 * invDet;
	r0[2][1] = ( mat_[0*6+1] * mat_[2*6+0] - mat_[0*6+0] * mat_[2*6+1] ) * invDet;
	r0[2][2] = ( mat_[0*6+0] * mat_[1*6+1] - mat_[0*6+1] * mat_[1*6+0] ) * invDet;

	// r1 = r0 * m1;
	r1[0][0] = r0[0][0] * mat_[0*6+3] + r0[0][1] * mat_[1*6+3] + r0[0][2] * mat_[2*6+3];
	r1[0][1] = r0[0][0] * mat_[0*6+4] + r0[0][1] * mat_[1*6+4] + r0[0][2] * mat_[2*6+4];
	r1[0][2] = r0[0][0] * mat_[0*6+5] + r0[0][1] * mat_[1*6+5] + r0[0][2] * mat_[2*6+5];
	r1[1][0] = r0[1][0] * mat_[0*6+3] + r0[1][1] * mat_[1*6+3] + r0[1][2] * mat_[2*6+3];
	r1[1][1] = r0[1][0] * mat_[0*6+4] + r0[1][1] * mat_[1*6+4] + r0[1][2] * mat_[2*6+4];
	r1[1][2] = r0[1][0] * mat_[0*6+5] + r0[1][1] * mat_[1*6+5] + r0[1][2] * mat_[2*6+5];
	r1[2][0] = r0[2][0] * mat_[0*6+3] + r0[2][1] * mat_[1*6+3] + r0[2][2] * mat_[2*6+3];
	r1[2][1] = r0[2][0] * mat_[0*6+4] + r0[2][1] * mat_[1*6+4] + r0[2][2] * mat_[2*6+4];
	r1[2][2] = r0[2][0] * mat_[0*6+5] + r0[2][1] * mat_[1*6+5] + r0[2][2] * mat_[2*6+5];

	// r2 = m2 * r1;
	r2[0][0] = mat_[3*6+0] * r1[0][0] + mat_[3*6+1] * r1[1][0] + mat_[3*6+2] * r1[2][0];
	r2[0][1] = mat_[3*6+0] * r1[0][1] + mat_[3*6+1] * r1[1][1] + mat_[3*6+2] * r1[2][1];
	r2[0][2] = mat_[3*6+0] * r1[0][2] + mat_[3*6+1] * r1[1][2] + mat_[3*6+2] * r1[2][2];
	r2[1][0] = mat_[4*6+0] * r1[0][0] + mat_[4*6+1] * r1[1][0] + mat_[4*6+2] * r1[2][0];
	r2[1][1] = mat_[4*6+0] * r1[0][1] + mat_[4*6+1] * r1[1][1] + mat_[4*6+2] * r1[2][1];
	r2[1][2] = mat_[4*6+0] * r1[0][2] + mat_[4*6+1] * r1[1][2] + mat_[4*6+2] * r1[2][2];
	r2[2][0] = mat_[5*6+0] * r1[0][0] + mat_[5*6+1] * r1[1][0] + mat_[5*6+2] * r1[2][0];
	r2[2][1] = mat_[5*6+0] * r1[0][1] + mat_[5*6+1] * r1[1][1] + mat_[5*6+2] * r1[2][1];
	r2[2][2] = mat_[5*6+0] * r1[0][2] + mat_[5*6+1] * r1[1][2] + mat_[5*6+2] * r1[2][2];

	// r3 = r2 - m3;
	r3[0][0] = r2[0][0] - mat_[3*6+3];
	r3[0][1] = r2[0][1] - mat_[3*6+4];
	r3[0][2] = r2[0][2] - mat_[3*6+5];
	r3[1][0] = r2[1][0] - mat_[4*6+3];
	r3[1][1] = r2[1][1] - mat_[4*6+4];
	r3[1][2] = r2[1][2] - mat_[4*6+5];
	r3[2][0] = r2[2][0] - mat_[5*6+3];
	r3[2][1] = r2[2][1] - mat_[5*6+4];
	r3[2][2] = r2[2][2] - mat_[5*6+5];
	...
	// r2 = m2 * r0;
	r2[0][0] = mat_[3*6+0] * r0[0][0] + mat_[3*6+1] * r0[1][0] + mat_[3*6+2] * r0[2][0];
	r2[0][1] = mat_[3*6+0] * r0[0][1] + mat_[3*6+1] * r0[1][1] + mat_[3*6+2] * r0[2][1];
	r2[0][2] = mat_[3*6+0] * r0[0][2] + mat_[3*6+1] * r0[1][2] + mat_[3*6+2] * r0[2][2];
	r2[1][0] = mat_[4*6+0] * r0[0][0] + mat_[4*6+1] * r0[1][0] + mat_[4*6+2] * r0[2][0];
	r2[1][1] = mat_[4*6+0] * r0[0][1] + mat_[4*6+1] * r0[1][1] + mat_[4*6+2] * r0[2][1];
	r2[1][2] = mat_[4*6+0] * r0[0][2] + mat_[4*6+1] * r0[1][2] + mat_[4*6+2] * r0[2][2];
	r2[2][0] = mat_[5*6+0] * r0[0][0] + mat_[5*6+1] * r0[1][0] + mat_[5*6+2] * r0[2][0];
	r2[2][1] = mat_[5*6+0] * r0[0][1] + mat_[5*6+1] * r0[1][1] + mat_[5*6+2] * r0[2][1];
	r2[2][2] = mat_[5*6+0] * r0[0][2] + mat_[5*6+1] * r0[1][2] + mat_[5*6+2] * r0[2][2];

	// m2 = r3 * r2;
	mat_[3*6+0] = r3[0][0] * r2[0][0] + r3[0][1] * r2[1][0] + r3[0][2] * r2[2][0];
	mat_[3*6+1] = r3[0][0] * r2[0][1] + r3[0][1] * r2[1][1] + r3[0][2] * r2[2][1];
	mat_[3*6+2] = r3[0][0] * r2[0][2] + r3[0][1] * r2[1][2] + r3[0][2] * r2[2][2];
	mat_[4*6+0] = r3[1][0] * r2[0][0] + r3[1][1] * r2[1][0] + r3[1][2] * r2[2][0];
	mat_[4*6+1] = r3[1][0] * r2[0][1] + r3[1][1] * r2[1][1] + r3[1][2] * r2[2][1];
	mat_[4*6+2] = r3[1][0] * r2[0][2] + r3[1][1] * r2[1][2] + r3[1][2] * r2[2][2];
	mat_[5*6+0] = r3[2][0] * r2[0][0] + r3[2][1] * r2[1][0] + r3[2][2] * r2[2][0];
	mat_[5*6+1] = r3[2][0] * r2[0][1] + r3[2][1] * r2[1][1] + r3[2][2] * r2[2][1];
	mat_[5*6+2] = r3[2][0] * r2[0][2] + r3[2][1] * r2[1][2] + r3[2][2] * r2[2][2];

	// m0 = r0 - r1 * m2;
	mat_[0*6+0] = r0[0][0] - r1[0][0] * mat_[3*6+0] - r1[0][1] * mat_[4*6+0] - r1[0][2] * mat_[5*6+0];
	mat_[0*6+1] = r0[0][1] - r1[0][0] * mat_[3*6+1] - r1[0][1] * mat_[4*6+1] - r1[0][2] * mat_[5*6+1];
	mat_[0*6+2] = r0[0][2] - r1[0][0] * mat_[3*6+2] - r1[0][1] * mat_[4*6+2] - r1[0][2] * mat_[5*6+2];
	mat_[1*6+0] = r0[1][0] - r1[1][0] * mat_[3*6+0] - r1[1][1] * mat_[4*6+0] - r1[1][2] * mat_[5*6+0];
	mat_[1*6+1] = r0[1][1] - r1[1][0] * mat_[3*6+1] - r1[1][1] * mat_[4*6+1] - r1[1][2] * mat_[5*6+1];
	mat_[1*6+2] = r0[1][2] - r1[1][0] * mat_[3*6+2] - r1[1][1] * mat_[4*6+2] - r1[1][2] * mat_[5*6+2];
	mat_[2*6+0] = r0[2][0] - r1[2][0] * mat_[3*6+0] - r1[2][1] * mat_[4*6+0] - r1[2][2] * mat_[5*6+0];
	mat_[2*6+1] = r0[2][1] - r1[2][0] * mat_[3*6+1] - r1[2][1] * mat_[4*6+1] - r1[2][2] * mat_[5*6+1];
	mat_[2*6+2] = r0[2][2] - r1[2][0] * mat_[3*6+2] - r1[2][1] * mat_[4*6+2] - r1[2][2] * mat_[5*6+2];

	// m1 = r1 * r3;
	mat_[0*6+3] = r1[0][0] * r3[0][0] + r1[0][1] * r3[1][0] + r1[0][2] * r3[2][0];
	mat_[0*6+4] = r1[0][0] * r3[0][1] + r1[0][1] * r3[1][1] + r1[0][2] * r3[2][1];
	mat_[0*6+5] = r1[0][0] * r3[0][2] + r1[0][1] * r3[1][2] + r1[0][2] * r3[2][2];
	mat_[1*6+3] = r1[1][0] * r3[0][0] + r1[1][1] * r3[1][0] + r1[1][2] * r3[2][0];
	mat_[1*6+4] = r1[1][0] * r3[0][1] + r1[1][1] * r3[1][1] + r1[1][2] * r3[2][1];
	mat_[1*6+5] = r1[1][0] * r3[0][2] + r1[1][1] * r3[1][2] + r1[1][2] * r3[2][2];
	mat_[2*6+3] = r1[2][0] * r3[0][0] + r1[2][1] * r3[1][0] + r1[2][2] * r3[2][0];
	mat_[2*6+4] = r1[2][0] * r3[0][1] + r1[2][1] * r3[1][1] + r1[2][2] * r3[2][1];
	mat_[2*6+5] = r1[2][0] * r3[0][2] + r1[2][1] * r3[1][2] + r1[2][2] * r3[2][2];
