...
public:
	...
	void	CompressImageDXT1AlphaHQ( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }
	...
	void	CompressImageCTX1Fast( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }
	void	CompressImageCTX1Fast_Generic( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }
	void	CompressImageCTX1Fast_SSE2( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }
	...
	void	CompressImageDXN1HQ( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }
	...
	void	CompressImageDXN1Fast_SSE2( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }
	...
	void	CompressYCoCgCTX1DXT5AFast_SSE2( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }
	...
	void	CompressNormalMapDXT1Fast( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }
	void	CompressNormalMapDXT1Fast_Generic( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }
	void	CompressNormalMapDXT1Fast_SSE2( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }
	...
	void	CompressNormalMapDXN2Fast_SSE2( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }
	...
	void	ConvertImageDXT1_DXN1( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }
...
========================
*/
ID_INLINE void idDxtEncoder::CompressImageDXT1Fast( const byte *inBuf, byte *outBuf, int width_, int height_ ) {
#ifdef ID_WIN_X86_SSE2_INTRIN
	CompressImageDXT1Fast_SSE2( inBuf, outBuf, width_, height_ );
#else
	CompressImageDXT1Fast_Generic( inBuf, outBuf, width_, height_ );
#endif
}
...
========================
*/
ID_INLINE void idDxtEncoder::CompressImageDXT1AlphaFast( const byte *inBuf, byte *outBuf, int width_, int height_ ) {
#ifdef ID_WIN_X86_SSE2_INTRIN
	CompressImageDXT1AlphaFast_SSE2( inBuf, outBuf, width_, height_ );
#else
	CompressImageDXT1AlphaFast_Generic( inBuf, outBuf, width_, height_ );
#endif
}
...
========================
*/
ID_INLINE void idDxtEncoder::CompressImageDXT5Fast( const byte *inBuf, byte *outBuf, int width_, int height_ ) {
#ifdef ID_WIN_X86_SSE2_INTRIN
	CompressImageDXT5Fast_SSE2( inBuf, outBuf, width_, height_ );
#else
	CompressImageDXT5Fast_Generic( inBuf, outBuf, width_, height_ );
#endif
}
...
========================
*/
ID_INLINE void idDxtEncoder::CompressImageDXN1Fast( const byte *inBuf, byte *outBuf, int width_, int height_ ) {
	CompressImageDXN1Fast_Generic( inBuf, outBuf, width_, height_ );
}
...
========================
*/
ID_INLINE void idDxtEncoder::CompressYCoCgDXT5Fast( const byte *inBuf, byte *outBuf, int width_, int height_ ) {
#ifdef ID_WIN_X86_SSE2_INTRIN
	CompressYCoCgDXT5Fast_SSE2( inBuf, outBuf, width_, height_ );
#else
	CompressYCoCgDXT5Fast_Generic( inBuf, outBuf, width_, height_ );
#endif
}
...
========================
*/
ID_INLINE void idDxtEncoder::CompressYCoCgCTX1DXT5AFast( const byte *inBuf, byte *outBuf, int width_, int height_ ) {
	CompressYCoCgCTX1DXT5AFast_Generic( inBuf, outBuf, width_, height_ );
}
...
========================
*/
ID_INLINE void idDxtEncoder::CompressNormalMapDXT5Fast( const byte *inBuf, byte *outBuf, int width_, int height_ ) {
#ifdef ID_WIN_X86_SSE2_INTRIN
	CompressNormalMapDXT5Fast_SSE2( inBuf, outBuf, width_, height_ );
#else
	CompressNormalMapDXT5Fast_Generic( inBuf, outBuf, width_, height_ );
#endif
}
...
========================
*/
ID_INLINE void idDxtEncoder::CompressNormalMapDXN2Fast( const byte *inBuf, byte *outBuf, int width_, int height_ ) {
	CompressNormalMapDXN2Fast_Generic( inBuf, outBuf, width_, height_ );
}
...
public:	
	...
	// CTX1
	void	DecompressImageCTX1( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }

	// DXN1
	void	DecompressImageDXN1( const byte *inBuf, byte *outBuf, int width_, int height_ ) { /* not implemented */ assert( 0 ); }
